                ...
                <div className="row col-md-12">
                    <div className="wrapperAccueil">
                        ...
                        <article className="textAccueil contGrille2Accueil">
                            ...
                            <p className="acceuilPara">Pas envie de courir seul, baisse de motivation!!</p>
                            <p className="acceuilPara">Venez rejoindre un groupe de coureurs motivés, ambiancés, qui saura vous redonner l'envie de courir, progresser, où il y a toujours quelqu'un pour vous accompagner, vous tirer, vous encourager dans la bonne humeur.</p>
                        </article>
                        <article className="textAccueil contGrille3Accueil">
                            ...
                            <p className="acceuilPara">Nos entraînements sont dispensés à des horaires fixes, sur des lieux définis, par des entraineurs bénévoles, toujours dans la bonne humeur et le respect de chacun. Ils sont adaptés dans la mesure du possible aux attentes et ambitions de chacun.</p>
                        </article>
